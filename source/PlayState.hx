...
class PlayState extends MusicBeatState
{
	...
	var funnyFloatyBoys:Array<String> = ['dave-angey', 'bambi-3d', 'expunged', 'bambi-unfair', 'exbungo', 'dave-festival-3d', 'dave-3d-recursed', 'bf-3d', 'bambi-pissboy'];
	...
	override public function create()
	{
		...
		if(SONG.stage == null)
		{
			switch(SONG.song.toLowerCase())
			{
				...
				case 'shredder' | 'greetings':
					stageCheck = 'festival';
				case 'interdimensional' | 'interdimensional-kogre':
				...
				case 'nomoreinnocence':
					stageCheck = 'nomoreinnocence';
			}
		}
		else
		{
		...
		switch (SONG.song.toLowerCase())
		{
			case 'polygonized' | 'interdimensional' | 'interdimensional-kogre':
		...
		if (!isGreetingsCutscene)
		{
			...
			kadeEngineWatermark = new FlxText(4, textYPos, 0, funkyText + difficulty[storyDifficulty], 16);
	...
	override public function update(elapsed:Float)
	{
		...
		if (SONG.song.toLowerCase() == 'interdimensional-kogre')
		{
			var speed = 300;
			flyingBgChars.forEach(function(bgChar:FlyingBGChar)
			{
